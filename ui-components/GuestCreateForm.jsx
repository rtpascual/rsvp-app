    ...
    >
      ...
      <SwitchField
        ...
        onChange={(e) => {
          ...
          if (errors.rsvp?.hasError) {
            runValidationTasks("rsvp", value);
          }
          setRsvp(value);
        }}
        onBlur={() => runValidationTasks("rsvp", rsvp)}
        errorMessage={errors.rsvp?.errorMessage}
